...
const props = defineProps({
    ...
    disabledOptionReferencia: {
        type: Boolean,
        default: false,
    },
    disabledOptionGarantia: {
        type: Boolean,
        default: false,
    },
}); 
...
const optionReferencia = ref(false);
const optionGarantia = ref(false);
...
watch(() => props.show, () => {
    ...
    optionGarantia.value = props.disabledOptionGarantia;
    optionReferencia.value = props.disabledOptionReferencia; 
    console.log(`referencia ${optionReferencia.value} garantia ${optionGarantia.value}`)
});
...
const items = {
    header : [ { 
            ...
            disabled: optionReferencia.value,  }, 
        { 
...
const onSave = () => {
    emit('onSave', { 
        referencias: lstReferencias.value,
        garantias: lstGarantias.value,
    });
}
                                    ...
                                    <div
                                        ...
                                        <div v-if="items.header[2].onSelected.value"> 
                                            ...
                                            <div class="flex flex-row w-full justify-end">
                                                <fw-button v-on:click="onSave()" type="button">Guardar</fw-button>
                                            </div>
