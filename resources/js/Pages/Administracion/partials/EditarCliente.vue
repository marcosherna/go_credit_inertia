...
onMounted( async () => {
    await filtrarDepartamentos(props.cliente.PAIS_NAC);
    await filtrarMunicipios(props.cliente.DEPA_NAC);

    form.CLIE_NOMBRE = `${props.cliente.CLIE_NOMBRE} ${props.cliente.CLIE_NOMBRE2} ${props.cliente.CLIE_NOMBRE3??''}` ;
    form.CLIE_APELLIDO = `${props.cliente.CLIE_APELLIDO} ${props.cliente.CLIE_APELLIDO2} ${props.cliente.CLIE_APELLIDO3??''}`
    form.CLIE_SEXO = controller.genero.find((g) => g.value == props.cliente.CLIE_SEXO).text;
    form.ESTA_ID = props.cliente.ESTA_ID;
    form.CLIE_MAIL = props.cliente.CLIE_MAIL;
    form.CLIE_MAIL2 = props.cliente.CLIE_MAIL2;
    form.CLIE_FECHANAC = props.cliente.CLIE_FECHANAC;
    form.PAIS_NAC = props.cliente.PAIS_NAC;
    form.DEPA_NAC = props.cliente.DEPA_NAC;
    form.MUNI_ID = props.cliente.MUNI_ID;
    form.CLIE_TEL = props.cliente.CLIE_TEL;
    form.CLIE_TEL2 = props.cliente.CLIE_TEL2;
    form.CLIE_DOCIDEN = props.cliente.CLIE_DOCIDEN;
    form.CLIE_DOCIDENVEN = props.cliente.CLIE_DOCIDENVEN;
    form.CLIE_DOCFISCAL = props.cliente.CLIE_DOCFISCAL;
    form.CLIE_PASAPORTE = props.cliente.CLIE_PASAPORTE;
    form.CLIE_OTRODOC = props.cliente.CLIE_OTRODOC;
    form.CLIE_DIRECCION = props.cliente.CLIE_DIRECCION;
    form.CLIE_PROFESION = props.cliente.CLIE_PROFESION;
    form.CLIE_TRABAJO = props.cliente.CLIE_TRABAJO;
    form.CLIE_TRABAJODIR = props.cliente.CLIE_TRABAJODIR;
    form.CLIE_TRABAJOTEL = props.cliente.CLIE_TRABAJOTEL;
    form.CLIE_INGRESOS = props.cliente.CLIE_INGRESOS.toString();
    form.CLIE_INGRESOORIGEN = props.cliente.CLIE_INGRESOORIGEN;
    form.CLIE_REF1NOMBRE = props.cliente.CLIE_REF1NOMBRE;
    form.CLIE_REF1PARENTESCO = props.cliente.CLIE_REF1PARENTESCO;
    form.CLIE_REF1TELEFONO = props.cliente.CLIE_REF1TELEFONO;
    form.CLIE_REF1DIRECCION = props.cliente.CLIE_REF1DIRECCION;
    form.CLIE_REF2NOMBRE = props.cliente.CLIE_REF2NOMBRE;
    form.CLIE_REF2PARENTESCO = props.cliente.CLIE_REF2PARENTESCO;
    form.CLIE_REF2TELEFONO = props.cliente.CLIE_REF2TELEFONO;
    form.CLIE_REF2DIRECCION = props.cliente.CLIE_REF2DIRECCION;
    form.CLIE_CATEGORIA = props.cliente.CLIE_CATEGORIA;
    form.CLIE_TIPOEMPLEO = controller.tipoEmpleo.find((t) => t.value == props.cliente.CLIE_TIPOEMPLEO).text;
    form.CLIE_TIPOCASA = controller.tipoCasa.find((t) => t.value == props.cliente.CLIE_TIPOCASA).text;
    form.CLIE_INGRESOPROM = controller.ingresoPromedio.find((i) => i.value == props.cliente.CLIE_INGRESOPROM).text;
    form.CLIE_ANTECEDENTES = props.cliente.CLIE_ANTECEDENTES;

    if(form.CLIE_ANTECEDENTES == 1){
        antecentesSi.value = true;
        antecentesNo.value = false;
    }else{
        antecentesSi.value = false;
        antecentesNo.value = true;
    }
    ...
    if(form.CLIE_INGRESOADIC = 1){
        ingresosAdicionalesSi.value = true;
        ingresosAdicionalesNo.value = false;
    }else{
        ingresosAdicionalesSi.value = false;
        ingresosAdicionalesNo.value = true;
    }


    form.CLIE_TIPOCLIENTE = props.cliente.CLIE_TIPOCLIENTE;
    form.CLIE_INGRESOADIC = props.cliente.CLIE_INGRESOADIC;
    form.SUCU_ID = props.cliente.SUCU_ID;
});
